...
public class project {
    public static void main(String[] args) throws Exception {
        ...
        CK.sendKeys("起飞");
        bottom.click();
        WebDriver adTWO=new ChromeDriver();
        String ad=adTWO.getCurrentUrl();
        adTWO.get(ad);
        //int mark[10];
        for(int time=0;time<=7;time++)
        {
            WebElement address = adTWO.findElement(By.xpath("//class[@class='list-container videolist clearfix']"));
